 ...
 * @param {Record<string, any>|null|undefined} account
 * @param {{ fetchImpl?: Function, timeoutMs?: number, signal?: AbortSignal }} [opts]
 */
export async function fetchBackendQuota(account, { fetchImpl = proxyFetch, timeoutMs = 10_000, signal = AbortSignal.timeout(timeoutMs) } = {}) {
